module.exports = {
	...
	rules: {
		...
		'@typescript-eslint/member-ordering': ['error', { 'default': [
			...
			'private-instance-method', 'private-abstract-method',
		] }],
		...
		'max-depth': ['error', 4],
		'max-len': ['error', {
			code: 120, tabWidth: 4, comments: 120,
			ignoreComments: true, ignoreUrls: true, ignoreTemplateLiterals: true, ignoreRegExpLiterals: true
		}],
